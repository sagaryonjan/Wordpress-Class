...
<div id="header">
	...
	<div class="col-lg-3">
	<div class="logo">
	<img src="images/transvis-logo.png">
	</div>
	</div>
	<div class="col-lg-7">
...
<div class="row">
<div class="col-lg-8">
<div class="all_view_title">
afafa sgsdgs sgsdgsdg sgsdgsdg sgsdg sgsgd
</div>
<div class="all_view_image">
<img src="images/about.jpg">
</div>

<div class="all_view_details">
ffafasfa afhajfaslkfsahjfklsahfsajkfhasfksal ah fkjlashf ashaljkfhsa ashfkaslf hasfhsakjlf hfkjla shfasklf hsafklah ahfaklf afaklfhashfas ahfkjla hahsfl afhaskflas ashfkaslf ahsfka asfha klahf ashfaklf ahfk lafhasklfhsa ashfaslkfh ahfalsk hfaf asfhasfklashf hafa lhaflakfhaslkf ahffasklfha ashflkashfajsfh afhakslf ahflk ahf akf ahf kalafshkalfh afahjf lahfk ahf alh sdbsskjdlsdh hfskf sdghjsdjkf sfshgdfjksg sgsdfkjs sfghjskd  my name i shfsgf sfgsdjkf sfghsdjkf sd sddg sddhjfsldhfk sdfhfdkl  dfddsghfdhgfkj sfdgsdghjfg dfghdskjf sdghfsdjkfd sfgsdjkfdsgf shgfsdfksdgfsdjhf kgsdf sdghsdhghg sd ghdsjksdf sdgf skgfhsjdkf ghsdjkhfsdjhfhg dsdfdghjsdk sdghfjk sdmy nassjhsk ff ahgkgdajfdgfdk sdghsdk ag hagjk bhfsdjsdjkg sfghsdjfk sgfsdjkf sdfgdsfkjdfgsd sdfgfjksdjgfsdhf sfghdsjfkg dsfgdhjfsdgf sfgsdjkfsdgf fgs hjfsfg sfhksfl sfhskdlfhd sdfhsklfh sfhdslfh sfhjskl 
</div>
<div class="view_all_date_user">
<span>Posted By : Admin  ||  Posted On : 20453454353</span>
</div>
</div>
<div class="col-lg-4">
<div class="rightbar">
...
<ul class="clearfix">
<li class="fa fa-check" style="font-size:16px; color:green;"> <a href="#">Citizen Participation</a></li>
<li class="fa fa-check" style="font-size:16px; color:green;"> <a href="#">Citizen Participation</a></li>
<li class="fa fa-check" style="font-size:16px; color:green;"> <a href="#">Citizen Participation</a></li>
<li class="fa fa-check" style="font-size:16px; color:green;"> <a href="#">Citizen Participation</a></li>
<li class="fa fa-check" style="font-size:16px; color:green;"> <a href="#">Citizen Participation</a></li>
...
<p>“This battle will liberate us; we want to be involved in the decision making process. Women will not continue to be used as fillers,” declared Socorro Torres, coordinator of the Honduras Interparty Women’s Network (Red de Mujeres Interpartidarias de Honduras, or the Network). Torres’s comments were in response to the historic ratification of a pact between members of Honduras’s leading political parties, affirming women’s equality in political participation. On October, 20, 2016, party leaders and aspiring presidential 
...
<p>&copy All Right Reserved By  Ndi.org  2016 &nbsp; &nbsp; || &nbsp; &nbsp;  Design And Developed By  : ajhsaklfsajhfals k</p>
</div>
</div>
</div>
</div>

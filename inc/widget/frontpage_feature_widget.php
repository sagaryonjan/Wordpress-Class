...
class Featured_widget extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <input class="widefat" type="text" id="<?php $this->get_field_id('head_title'); ?>" name="<?php echo $this->get_field_name('head_title') ?>" value="<?php echo $head_title;?>">
        </p>
        <p>
            <label for="<?php $this->get_field_id('title'); ?>"><?php esc_html_e('Title','blog')?></label>
            <input type="text" class="widefat" id="<?php $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title') ?>" value="<?php echo $title;?>">
        </p>
        <p>
            <label for="<?php $this->get_field_id('description'); ?>"><?php esc_html_e('Description','blog')?></label>
            <textarea class="widefat" id="<?php $this->get_field_id('description'); ?>" name="<?php echo $this->get_field_name('description'); ?>"><?php echo $description;?></textarea>
        </p>
        <p>
            <label for="<?php $this->get_field_id('link'); ?>"><?php esc_html_e('Link','blog')?></label>
            <input class="widefat" type="text" id="<?php $this->get_field_id('link'); ?>" name="<?php echo $this->get_field_name('link') ?>" value="<?php echo $link;?>">
        </p>
        <?php
    }

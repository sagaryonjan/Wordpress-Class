...
<button class="tiny" id="ndi_act_btn"> Ndi Activities  <i class="fa fa-list"></i> </button> <button class="tiny" id="ndi_track_btn">Track Records <i class="fa fa-bars"></i> </button> <button class="tiny" id="ndi_service_btn">Services <i class="fa fa-list"></i> </button>
<div class="recent_blog_main" id="ndi_act_main_div">
<div class="col-lg-12">
<ul class="clearfix">
<li class="fa fa-check" style="font-size:16px; color:green;"> <a href="#">Citizen Participationdsgsdhgsdlkgjsdjlkdg </a></li>
<li class="fa fa-check" style="font-size:16px; color:green;"> <a href="#">Citizen Participationdsgsdhgsdlkgjsdjlkdg </a></li>
<li class="fa fa-check" style="font-size:16px; color:green;"> <a href="#">Citizen Participationdsgsdhgsdlkgjsdjlkdg </a></li>
<li class="fa fa-check" style="font-size:16px; color:green;"> <a href="#">Citizen Participationdsgsdhgsdlkgjsdjlkdg </a></li>
<li class="fa fa-check" style="font-size:16px; color:green;"> <a href="#">Citizen Participationdsgsdhgsdlkgjsdjlkdg </a></li>
...
<ul class="clearfix">
<li>ssdfdsfsdfsdffafafaf afafafasf afaf afafkl a afagf afga aagfa afga asfhjsak agf aakfga f afg akfjgasgsdgsdgsdgsgs </li>
</ul>
</div>
</div>
